...
import by.morozmaksim.AgroTechCare.repository.WorkOrderRepository;
...
public class WorkOrderServiceImpl implements WorkOrderService {
    ...
    @Override
    public WorkOrder update(WorkOrderDto workOrderDto, Long id) {
        WorkOrder excistingWorkOrder = findById(id);
