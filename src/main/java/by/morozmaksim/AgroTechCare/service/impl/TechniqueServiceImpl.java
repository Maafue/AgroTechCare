...
import by.morozmaksim.AgroTechCare.repository.TechniqueRepository;
import by.morozmaksim.AgroTechCare.service.BrandService;
import by.morozmaksim.AgroTechCare.service.TechniqueService;
...
public class TechniqueServiceImpl implements TechniqueService {
    ...
    @Override
    public Technique update(TechniqueDto techniqueDto, Long id) {
        Technique excistingTechnique = findById(id);
